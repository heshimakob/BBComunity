...
<h1 className="inline-block mb-8 px-3 py-1 text-white font-semibold bg-gray-600 rounded-full">#Black Born Community bootcamp(BBC dev)</h1>
...
<div className="flex flex-wrap -m-1 mb-14">
  <div className="w-auto p-2"><a className="inline-block px-5 py-4 text-white font-semibold tracking-tight bg-indigo-500 hover:bg-indigo-600 rounded-lg focus:ring-4 focus:ring-indigo-400 transition duration-200" href="#">Apply now</a></div>
