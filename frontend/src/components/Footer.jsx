...
<img className="mb-16 h-9" src="fily-assets/logos/fily-treck-white-logo.svg" alt />
...
<div className="relative h-full py-12 px-10">
  ...
  <div className="relative p-1.5 bg-transparent border border-gray-500 focus-within:ring focus-within:ring-blue-200 rounded-2xl md:rounded-full transiiton duration-200">
    <div className="relative">
      <input id="footers-input-01-1" type="text" className="py-3 px-6 sm:pr-14 w-full text-gray-500 placeholder-gray-500 font-semibold text-center md:text-left bg-transparent outline-none" placeholder="Your email address" />
      <a href="#" className="md:absolute md:top-0 md:right-0 inline-flex justify-center items-center w-full md:w-12 h-12 md:h-full text-white hover:text-white focus:text-white bg-blue-500 hover:bg-blue-600 focus:bg-blue-600 rounded-2xl md:rounded-full transition duration-200">
