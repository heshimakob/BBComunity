...
const Login = ({ setProgress }) => {
  ...
  const [showPassword, setShowPassword] = useState(false); // Etat pour la visibilité du mot de passe
            ...
            <div className="w-full max-w-lg mx-auto lg:mx-0 my-auto">
              ...
              <form className="mt-14" onSubmit={handleSubmit}>
                ...
                <div className="flex mb-6 px-4 bg-blueGray-50 rounded">
                  <input
                    type={showPassword ? 'text' : 'password'} // Change le type d'input en fonction de l'état
                    id="password"
