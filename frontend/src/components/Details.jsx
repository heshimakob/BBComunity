...
const  Details =()=>{
  ...
  return (
    ...
    <h1 className="text-4xl font-bold mb-4 pt-10"> Vous pouvez nous contacter !</h1>
    <p className="text-lg mb-8 text-center">
     Nous sommes situe en RDC , ville de Bukavu, commune d'ibanda, Quartier Muhumba ,Av horizon .
      <br />
      Dans le batiment de l'hotel horizon
    </p>

    <div className="flex gap-4 mb-8">
      <button
        className="bg-gray-800 hover:bg-gray-700 text-white font-bold py-3 px-5 inline-flex items-center transition duration-300 ease-in-out"
      ...
      <button
        className="bg-blue-500 hover:bg-blue-400 text-white font-bold py-2 px-4  inline-flex items-center transition duration-300 ease-in-out"
        onMouseEnter={handleMouseEnter}
        onMouseLeave={handleMouseLeave}
      >
        {isHovered ? (
