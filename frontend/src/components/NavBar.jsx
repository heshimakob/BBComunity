...
<div className="w-auto hidden lg:block">
  <ul className="flex items-center mr-8">
    <li className="mr-14 font-medium text-white hover:text-gray-200 tracking-tight"><a href="#">Features</a></li>
    <li className="mr-14 font-medium text-white hover:text-gray-200 tracking-tight"><a href="#">Pricing</a></li>
    <li className="mr-8 font-medium text-white hover:text-gray-200 tracking-tight border-r border-gray-700 pr-8"><a href="#">Automation</a></li>
...
<div className="pt-16 lg:pt-32 pb-24 lg:pb-52 bg-black overflow-hidden">
<div className="container px-4 mx-auto">
<div className="flex flex-wrap -m-8">
<div className="w-full md:w-1/2 p-8">
<div className="md:max-w-lg">
<span className="inline-block mb-8 px-3 py-1 text-white font-semibold bg-gray-600 rounded-full">#1 Brand Building Tool</span>
<h1 className="font-heading mb-12 text-6xl md:text-7xl text-white tracking-tighter">Entreprendre dans les ICC</h1>
  ...
  <div className="flex flex-wrap -m-1.5">
    <div className="w-auto p-1.5">
      <div className="flex flex-wrap">
        <div className="w-auto">
          {/* <img src="basko-assets/images/headers/avatar.png" alt /> */}
        </div>
        <div className="w-auto -ml-5">
          <img src="basko-assets/images/headers/avatar2.png" alt />
        </div>
        <div className="w-auto -ml-5">
          <img src="basko-assets/images/headers/avatar3.png" alt />
        </div>
      </div>
    </div>
    <div className="flex-1 p-1.5">
      <p className="text-white tracking-tight">Join other 12k+ Marketers and start building brands reputation now.</p>
    </div>
  </div>
</div>
</div>
