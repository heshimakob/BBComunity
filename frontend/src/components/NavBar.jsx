...
import { AiOutlineMenu, AiOutlineClose, AiOutlineCloseCircle } from 'react-icons/ai'; // Assurez-vous d'avoir installé 'react-icons'
  ...
  return (
    <>
      <div className="fixed top-0 w-full z-50 bg-gray-900">
        {isBannerVisible && (
          <div className="relative py-1 text-center bg-pink-500">
            <div className="text-sm font-light text-white">
              ...
              <button onClick={closeBanner} className="absolute right-4 top-1/2 transform -translate-y-1/2 text-white">
        ...
        <nav className="bbc-container relative px-12 py-5">
          <div className="flex items-center justify-between">
            <Link className="relative z-10 pr-4 lg:pr-0" to="/">
              <img className="h-[72px] border-0" src={bbcc} alt="Logo" />
            </Link>
