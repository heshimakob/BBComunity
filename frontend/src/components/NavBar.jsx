    ...
    return (     
        <>       
            <section className="overflow-hidden fixed top-0 left-0 w-full z-50">         
                <div className="bg-gray-950">           
                    <div className="container px-4 mx-auto">             
                        <div className="flex items-center justify-between py-5">               
                            ...
                            <div className="w-auto hidden lg:hidden">                 
                ...
                {isOpen && (           
                    <div className={`fixed w-full top-0 right-0 h-full w-64 bg-gray-950 text-white transition-transform duration-300 ${isOpen ? 'translate-x-0' : 'translate-x-full'}`}>             
                        <div className="flex justify-between items-center p-4">               
                            <h2 className="font-bold lg:hidden">Menu</h2>               
                            <button onClick={toggleMenu} aria-label="Close Menu">                 
                                <AiOutlineClose className="text-white" size={24} />               
                            </button>             
                        </div>             
                        <nav className="flex flex-col items-start p-4 text-2xl">               
                            ...
                            <button onClick={handleTalentClick} className="mb-2 hover:text-gray-400">Engager un talent</button>            
                        </nav>           
                    </div>         
                )}       
            </section>     
