...
//             <NavBar />
//             <Sidebar />
//             <div className="container mx-auto my-8 px-4 sm:px-6 lg:px-8 mt-28 mb-20">
//                 <h1 className="text-2xl mb-6 text-center">Modifier votre profil</h1>
//                 <form className="flex flex-col gap-4 max-w-md mx-auto" onSubmit={handleSubmit}>
//                     <div className="flex items-center justify-center mb-4">
//                         {imagePreview ? (
//                             <img src={imagePreview} alt="Profile ta photo de profile" className="w-32 h-32 rounded-full bg-gray-500" />
//                         ) : (
